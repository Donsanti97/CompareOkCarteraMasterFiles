...
public class HistoricoCarteraMicrocreditoPorOF {
    ...
    public static void configuracion(String masterFile) {
        ...
        try {
            ...
            reEstCapital(okCartera, 0, 150, masterFile, azureFile, "Re_Est Capital < = 30", tempFile);
            waitSeconds(5);


            reEstCapital(okCartera, 151, 5000, masterFile, azureFile, "Re_Est Capital > 30", tempFile);
            waitSeconds(5);
            ...
            clientesComercial(okCartera, masterFile, azureFile, "Clientes_Microcredito", tempFile);
            waitSeconds(5);

            colocacionComercial(okCartera, masterFile, azureFile, mesAnoCorte, "Colocación_Microcredito", tempFile);
            waitSeconds(5);

            nCreditoComercial(okCartera, masterFile, azureFile, mesAnoCorte, "N° De Créd Microcredito", tempFile);
            waitSeconds(5);

            colocacionPromComercial(okCartera, masterFile, azureFile, mesAnoCorte, "Colocación Prom Microcredito", tempFile);
            waitSeconds(5);

            comercialPercentil05(okCartera, masterFile, azureFile, mesAnoCorte, "Microcredito Percentil 0.5", tempFile);
            waitSeconds(5);

            comercialPercentil08(okCartera, masterFile, azureFile, mesAnoCorte, "Microcredito Percentil 0.8", tempFile);
            waitSeconds(5);

            comercialPzoPerc05(okCartera, masterFile, azureFile, mesAnoCorte, "Microcredito_Pzo_Perc_0.5", tempFile);
            waitSeconds(5);

            comercialPzoProm(okCartera, masterFile, azureFile, mesAnoCorte, "Microcredito_Pzo_Prom", tempFile);
            waitSeconds(5);
            ...
            comercialPzoPerc08(okCartera, masterFile, azureFile, mesAnoCorte, "Microcredito_Pzo_Perc_0.8", tempFile);
            waitSeconds(5);
